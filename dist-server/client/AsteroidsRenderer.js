...
var AsteroidsRenderer = /*#__PURE__*/function (_Renderer) {
  ...
  function AsteroidsRenderer(gameEngine, clientEngine) {
    ...
    ctx.fillStyle = 'black';
    console.log("ctx.strokeStyle: " + ctx.strokeStyle); // remove instructions on first input
  ...
  _createClass(AsteroidsRenderer, [{
    ...
    value: function draw(t, dt) {
      ...
      game.world.forEachObject(function (id, obj) {
        if (obj instanceof _Ship["default"]) _this2.drawShip(obj.physicsObj);else if (obj instanceof _Bullet["default"]) _this2.drawBullet(obj.physicsObj);else if (obj instanceof _Aviary["default"]) _this2.drawAviary(obj.physicsObj);
