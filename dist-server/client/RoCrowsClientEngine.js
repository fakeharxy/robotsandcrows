...
var _RoCrowsRenderer = _interopRequireDefault(require("./RoCrowsRenderer"));
...
var RoCrowsClientEngine = /*#__PURE__*/function (_ClientEngine) {
  _inherits(RoCrowsClientEngine, _ClientEngine);

  var _super = _createSuper(RoCrowsClientEngine);

  function RoCrowsClientEngine(gameEngine, options) {
    var _this;

    _classCallCheck(this, RoCrowsClientEngine);

    _this = _super.call(this, gameEngine, options, _RoCrowsRenderer["default"]); //  Game input
    ...
    this.gameEngine.on('objectDestroyed', (obj) => {
        console.log("destroy event for obj:");
        console.log(obj);
    });
    */
  ...
  _createClass(RoCrowsClientEngine, [{
    key: "handleButton",
  ...
  return RoCrowsClientEngine;
}(_lanceGg.ClientEngine);

exports["default"] = RoCrowsClientEngine;

function isTouchDevice() {
  return 'ontouchstart' in window || navigator.maxTouchPoints;
}
//# sourceMappingURL=RoCrowsClientEngine.js.map