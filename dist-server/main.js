...
var _RoCrowsServerEngine = _interopRequireDefault(require("./server/RoCrowsServerEngine"));
...
var gameEngine = new _RoCrowsGameEngine["default"]({
  traceLevel: _lanceGg.Lib.Trace.TRACE_NONE
});
var serverEngine = new _RoCrowsServerEngine["default"](io, gameEngine, {
  debug: {},
  updateRate: 6
}); // start the game
