...
import RoCrowsRenderer from './RoCrowsRenderer';

const betaTiltThreshold = 40;
const gammaTiltThreshold = 40;
const steerThreshold = 0.4;

export default class RoCrowsClientEngine extends ClientEngine {

    constructor(gameEngine, options) {
        super(gameEngine, options, RoCrowsRenderer);
        ...
        if (isTouchDevice()) {
            ...
            this.controls.bindKey('down', 'down', { repeat: false } );
            this.controls.bindKey('left', 'left', { repeat: false } );
            this.controls.bindKey('right', 'right', { repeat: false } );
